...
- [x] **Use the full dataset:** Run the feature extraction pipeline on all 84,484 OCT images.
- [x] **Increase Quantum Dept:** Expand the PennyLane circuit from 4 layers to 8+ layers.
- [x] **Data Augmentation:** Apply random rotations, flips, and color jitter to the OCT and ODIR-5K fundus datasets during DataLoader initialization.
